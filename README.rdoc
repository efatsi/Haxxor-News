...
General Overview: Haxxor News is an app which allows users to post links to articles or other web pages, and opens up the floor for discussion on these article links. A user can comment on an article link, or on another comment as well. Comments are organized in a visual hierarchy indenting in further as the depth of the comment increases. A user can also upvote or downvote any article or comment.
